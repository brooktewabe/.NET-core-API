namespace LoginAPI.Models.Email
{
    public class HtmlTemplate
    {
        ...
        public string GetHtmlBody(string name, string url)
        {
                  ...
                  <tr>
                    <td class=""content-cell"">
                      <div class=""f-fallback"">
                        <h1>Hi {name},</h1>
                        <p>You recently requested to reset your password for your forgot password account. Use the button below to reset it. <strong>This password reset is only valid for the next 1 hour.</strong></p>
                        <!-- Action -->
